...
class EntangldMessage {
     ...
     * @return {EntangldMessage} - The get message to pass to the remote datastore
     */
     ...
     *
     * @param {EntangldMessage} get_msg - the `get` message which this is in response to
     * @param value - the value of the `get`
     * @return {EntangldMessage} - The `value` message to pass back
     */
     ...
     * @return {EntangldMessage} - the "set" or "push" message
     */
    ...
    * @return {EntangldMessage} the `subscribe` message
    */
     ...
     * @return {EntangldMessage} the `event` message
     */
...
module.exports = exports = EntangldMessage;
